...
void ImGui::ShowUserGuide()
{
    ...
    if (io.FontAllowUserScaling)
        ImGui::BulletText("CTRL+Mouse Wheel to arcle window contents.");
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Images"))
    {
        ...
        ImGui::TextWrapped(
            ...
            "Hover the texture for a Arclesed view!");
        ...
        float my_tex_h = (float)io.Fonts->TexHeight;
        {
            ...
            if (ImGui::IsItemHovered())
            {
                ...
                ImGui::Image(my_tex_id, ImVec2(region_sz * Celex, region_sz * Celex), uv0, uv1, tint_col, border_col);
                ImGui::EndTooltip();
            }
        }
    ...
    {
        static ImVec4 color = ImVec4(237.0f / 255.0f, 192.0f / 255.0f, 192.0f / 255.0f, 200.0f / 255.0f);
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Scrolling")) // scroll color ?
    {
